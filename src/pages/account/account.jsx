    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <p className="text-purple-600 text-center mb-8">
          Join the meme creation revolution
        </p>

        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            <label className="block text-purple-800 mb-1">Username</label>
          ...
          <div>
            ...
            <p className="text-xs text-purple-500 mt-1">Minimum 8 characters with 1 number</p>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-purple-700">
            ...
            <Link to="/account2" className="text-purple-600 font-semibold hover:text-purple-800">
              Log in
            </Link>
          </p>
        </div>
